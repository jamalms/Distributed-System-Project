...
public class PressureServiceDiscovery {
	...
	//public static void main(String[] args) {
		...
		try {
			...
			MyServiceListener mslPressure = new MyServiceListener();		
			jmdns.addServiceListener(service_type, mslPressure);

			
			//sleep for 10 seconds
			Thread.sleep(10000);
			
			serviceInfo = mslPressure.getServiceInfo();
			port = mslPressure.getPort();
